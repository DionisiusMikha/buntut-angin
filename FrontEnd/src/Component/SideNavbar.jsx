    ...
    return <>
        <div className='w-full flex flex-row bg-gray-200 h-screen'>
            <div className='my-10 bg-gray-50 mx-10 rounded-2xl drop-shadow-lg py-10'>
                ...
                <div className='h-20 ms-14' style={hovered=="home" ? {backgroundImage:bg, backgroundRepeat:"no-repeat"} : {backgroundColor:"transparent"}} onClick={()=>{
                    navigate("/dietisian");
                }}>
                ...
                <div className='h-20 ms-14' style={hovered=="recipes" ? {backgroundImage:bg, backgroundRepeat:"no-repeat"} : {backgroundColor:"transparent"}} onClick={()=>{
                ...
                <div className='h-20 ms-14' style={hovered=="report" ? {backgroundImage:bg, backgroundRepeat:"no-repeat"} : {backgroundColor:"transparent"}} onClick={()=>{
                ...
                <div className='h-20 ms-14' style={hovered=="chat" ? {backgroundImage:bg, backgroundRepeat:"no-repeat"} : {backgroundColor:"transparent"}} onClick={()=>{
