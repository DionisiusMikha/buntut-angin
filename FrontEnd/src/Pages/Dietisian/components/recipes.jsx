...
import userService from '../../../Services/Dietisian/dietisian';
...
function Recipes() {
  ...
  const getAllRecipes = async () =>{
    const allRecipes = await userService.getAllRecipes(page, limit, search);
          ...
          <div className='w-full h-full flex justify-center items-center'>
            <div className="w-9/12 h-full flex flex-col justify-center items-center">
              <div className='w-full h-full flex flex-col'>
                  ...
                  <div className='grid grid-cols-2 gap-8 mx-10 mt-5'>
                    <div className='row-span-2 bg-orange-100 rounded-3xl'>
                      <Card item={recipes[0]}></Card>
                    </div>
