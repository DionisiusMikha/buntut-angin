...
function DetailRecipes(){
    ...
    return (
        <>
            <div className="w-11/12 m-auto my-10">
                ...
                <div className="bg-white w-11/12 drop-shadow-xl mb-5 p-10 rounded-xl">
                    <div className="flex flex-row justify-between items-center">
                        ...
                        <button className="btn text-lg" onClick={showDialog}>Add Comment</button>
                    </div>
                    <div className="py-5">
            ...
            <DialogComment isOpen={isDialogOpen} onClose={closeDialog} recipeId={id} userId={userLogin.id}/>
        </>
    )
}
