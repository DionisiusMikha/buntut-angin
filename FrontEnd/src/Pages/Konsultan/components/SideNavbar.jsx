        ...
        <div className='w-full flex flex-row bg-gray-200 h-screen py-10'>
            <div className='w-full h-full bg-gray-50 ms-10 rounded-2xl drop-shadow-lg flex flex-col justify-evenly items-center'>
                ...
                <div className='w-1/2 h-8'>
                    <NavLink className='w-full h-full flex items-start hover:scale-90' to={`/konsultan/home`} style={(state) => {
                ...
                <div className='w-1/2 h-8'>
                    <NavLink className='w-full h-full flex justify-start items-center hover:scale-90' to={`/konsultan/recipes`} style={(state) => {
                        return state.isActive ? style : {backgroundColor:"transparent"}
                    }}>
                ...
                <div className='w-1/2 h-8'>
                    <NavLink className='w-full h-full flex justify-start items-center hover:scale-90' to={`/konsultan/patient-list`} style={(state) => {
                        return state.isActive ? style : {backgroundColor:"transparent"}
                    }}>
                ...
                <div className='w-1/2 h-8'>
                    <NavLink className='w-full h-full flex justify-start items-center hover:scale-90' to={`/konsultan/settings`} style={(state) => {
                        return state.isActive ? style : {backgroundColor:"transparent"}
                    }}>
